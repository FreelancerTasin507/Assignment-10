...
const AboutSection = () => {
  return (
    <div className="md:flex md:mx-14 justify-center items-center gap-4 ">
      <div className="bg-slate-100 md:w-1/2 rounded-2xl shadow-2xl px-14 py-32">
        <div className="text-center">
          <h1 className="md:text-5xl font-semibold mb-8">
            About Our <br /> <span className="md:text-7xl text-2xl">Resturant</span>
          </h1>
